# MUSE-gas-velocities: given a MUSE data cube, compute gas velocities on a pixel-by-pixel base. Also see the MUSE examples on http://pyspeckit.readthedocs.io/.
